...
class Turno:
    ...
    def chequeroDuplica(self,x,y,letra):
        ...
        try:
            ...
            elif self._Casilleros_Especiales[(x,y)]=="TP":
                    self._triplica_palabra.append(letra)
            elif self._Casilleros_Especiales[(x,y)]=="RS":
                self._resta.append(letra)
        except KeyError:
            pass
    ...
    def Armar_palabra_y(self,box_x,box_y):
        '''Forma la palabra cruzandola en eje y'''
    ...
    def EscribirEnTableroPosponer(self,box_x,box_y,g):
        '''Escribe una letra en la posicion que le llega por parametros'''
    ...
    def EscribirEnTablero(self,box_x,box_y,g,letra):
        '''Escribe en el tablero e invalida la posicion'''
